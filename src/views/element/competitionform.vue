    ...
    <div class="container">
        ...
        <el-form ref="formRef" :rules="rules" :model="form" label-width="120px" :label-position="labelPosition">
            <el-row :gutter="50">
                ...
                <el-col :span="12">
                    <el-form-item label="是否竞赛保研" prop="delivery">
                        <el-switch v-model="form.baoyan"></el-switch>
                    </el-form-item>
...
const rules: FormRules = {
    ...
    date: [{ required: true, message: '请输入竞赛时间', trigger: 'blur' }],
    baoyan: [{ required: true, message: '请输入是否可以保研', trigger: 'blur' }],
    desc: [{ required: true, message: '请输入竞赛简介', trigger: 'blur' }],
};
